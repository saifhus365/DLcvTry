...
def train_and_evaluate_model(model, train_loader,val_loader, optimizer, num_epochs, device, cocoval, num_classes, scheduler=None, early_stopping=False):
    ...
    for epoch in range(num_epochs):
        ...
        if scheduler:
            scheduler.step()
        visualize_single_image('/kaggle/input/construction-industry-steel-ordering-lists-cisol/cisol_TD-TSR/TD-TSR/images/val', epoch, result, '1239_00_0_00_231106_1000_Decke_Biegeliste_page_3_an.png')
